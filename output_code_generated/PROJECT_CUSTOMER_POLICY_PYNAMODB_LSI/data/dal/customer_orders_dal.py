...
def lsi__phone__index_query(pk: str, sort_key_condition=None, filter_key_condition=None) -> List[CustomerOrdersDto]:
    """
    Wrapper for LSI query by pk (table partition key) and optional phone condition.
