...
def test_create_or_update_sets_created_at_on_create(mock_dynamodb_table):
    """Test create_or_update sets created_at on new item."""
    dto = DdbTableOneDto(pk_attribute_str_1="cou_ca_pk", sk_attribute_str_2="cou_ca_sk", attribute_str_3="CA")
    ddb_table_one_create_or_update_item(dto)
    raw = table.get_item(Key={"pk_attribute_str_1": "cou_ca_pk", "sk_attribute_str_2": "cou_ca_sk"})["Item"]
    assert "created_at" in raw
    assert raw["created_at"].endswith("Z")
