...
def test_put_item_with_all_attributes(mock_dynamodb_table):
    """Test putting an item with all attributes populated."""
    dto = DdbTableTwoDto(
        pk_attr_str_1="all_pk", sk_attr_str_2="all_sk",
        attr_str_3="val3", attr_str_4="val4",
        attr_str_5="val5", attr_str_6="val6"
    )
    ddb_table_two_put_item(dto)
    result = ddb_table_two_get_item("all_pk", "all_sk")
    assert result is not None
    assert result.attr_str_3 == "val3"
    assert result.attr_str_4 == "val4"
    assert result.attr_str_5 == "val5"
    assert result.attr_str_6 == "val6"
...
def test_update_item_partial_attributes(mock_dynamodb_table):
    ...
    ddb_table_two_update_item(dto)
    result = ddb_table_two_get_item("pk1", "sk1")
    assert result.attr_str_5 == "new_str5"
    assert result.attr_str_3 == "str3_val1"  # Original preserved
