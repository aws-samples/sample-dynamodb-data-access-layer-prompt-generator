...
class PolicyManagerDto:
    """
    Data Transfer Object for PolicyManager (excludes system attributes).
    
    This DTO represents the PolicyManager entity without internal
    system attributes like created_at, updated_at, time_to_live, and version.
