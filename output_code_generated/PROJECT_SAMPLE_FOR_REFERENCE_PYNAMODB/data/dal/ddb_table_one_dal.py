...
def dto_to_model(dto: DdbTableOneDto) -> DdbTableOne:
    ...
    return DdbTableOne(
        ...
        gsipk_attribute_str_7=dto.gsipk_attribute_str_7,
        gsisk_attribute_str_8=dto.gsisk_attribute_str_8
    )
...
def model_to_dto(item: DdbTableOne) -> DdbTableOneDto:
    ...
    return DdbTableOneDto(
        ...
        gsipk_attribute_str_7=item.gsipk_attribute_str_7,
        gsisk_attribute_str_8=item.gsisk_attribute_str_8
    )
...
def gsi__gsipk_attribute_str_7__gsisk_attribute_str_8__index_query(gsipk_attribute_str_7: str, sort_key_condition=None) -> List[DdbTableOneDto]:
    """
    ...
    """
    return ddb_table_one_query(
        hash_key=gsipk_attribute_str_7,
        range_key_and_condition=sort_key_condition,
